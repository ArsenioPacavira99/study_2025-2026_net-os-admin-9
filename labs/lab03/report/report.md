...
1. **Схема L1 (физическая топология).**  
   ...
   ![Схема L1: физические соединения и интерфейсы](Lab-03-L-1.png){ #fig:01 width=80% }
...
2. **Схема L2 (VLAN и транковые соединения).**  
   ...
   ![Схема L2: распределение VLAN по линкам и портам](Lab-03-L-2.png){ #fig:02 width=80% }
...
3. **Схема L3 (план IP-адресации 10.128.0.0/16).**  
   ...
   ![Схема L3: подсети и назначение](Lab-03-L-3.png){ #fig:03 width=80% }
...
![Схема L3 для 172.16.0.0/12](Lab-03-L3-2.png){ #fig:04 width=80% }

2. **План адресного пространства для 192.168.0.0/16** (разбиение на /24 по назначениям):

![Схема L3 для 192.168.0.0/16](Lab-03-L3-3.png){ #fig:05 width=80% }
